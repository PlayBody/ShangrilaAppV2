...
class UserModel {
  ...
  const UserModel({
    ...
    this.groupId,
    this.deviceToken,
    required this.goldLevel,
    required this.isChangeBirthday,
  });
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      isPushReserveApply: (json['is_reserve_apply_push'] == null ||
          ...
          goldLevel: int.parse(json['user_is_gold']),
      isChangeBirthday: (json['is_change_birthday'] == null ||
          json['is_change_birthday'].toString() == '0') ? false : true,
    );
  }
}
